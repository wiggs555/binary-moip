"""Synchronous REST configuration client."""
...
from binary_moip.config.events import SyncEventClient
from binary_moip.config.transport import SyncTransport


class ConfigClient:
    """Synchronous client for the MoIP REST configuration API (v1.3.0)."""
    ...
    def __init__(
        ...
        *,
        ...
        self.events = SyncEventClient(base_url, self._token_manager, verify_ssl=verify_ssl)
